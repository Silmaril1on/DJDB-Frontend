...
const Ratings = ({ item, onClose }) => {
  ...
  return (
    <motion.div
      ...
      animate="visible"
      exit="exit"
      className="fixed inset-0 bg-black/70 backdrop-blur-md flex-center z-20"
    >
      <div className="bg-blue/40 backdrop-blur-3xl p-3 lg:p-8 relative">
        <GreenSvg />
        ...
        <div className="flex flex-col items-center space-y-4 py-4 lg:px-8">
